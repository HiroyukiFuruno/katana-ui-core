use katana_ui_core_egui_adapter::text_command_surface::{TabStripText, TabStripTextRasterizer};
use katana_ui_core_text_raster::{PlatformFontCatalog, PlatformTextRasterConfig};
use std::sync::Arc;
