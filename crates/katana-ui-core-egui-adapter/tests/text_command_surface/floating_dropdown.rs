...
pub(crate) fn last_item_run() -> Result<(), Box<dyn std::error::Error>> {
    ...
    assert_eq!(
        ...
        vec![
            katana_ui_core_egui_adapter::text_command_surface::EguiTextCommandSurfaceChild::Text,
            katana_ui_core_egui_adapter::text_command_surface::EguiTextCommandSurfaceChild::Floating,
        ]
    );
