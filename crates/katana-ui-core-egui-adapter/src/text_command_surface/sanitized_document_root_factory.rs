...
impl SanitizedDocumentRootFrame {
    ...
    #[cfg(test)]
    fn tab_closed_event_count(&self) -> usize {
        self.tab_closed_events.borrow().as_ref().map_or(0, Vec::len)
    }

    #[cfg(test)]
    fn tab_activation_event_count(&self) -> usize {
    ...
    #[cfg(test)]
    fn tab_close_request_event_count(&self) -> usize {
        self.tab_closed_events
            .borrow()
            .as_ref()
            .map_or(0, |events| {
    ...
    #[cfg(test)]
    fn tab_rects(&self) -> &[(String, egui::Rect)] {
        &self.tab_rects
    }

    #[cfg(test)]
    fn tab_close_rects(&self) -> &[(String, egui::Rect)] {
        &self.tab_close_rects
    }

    #[cfg(test)]
    fn command_action_rects(
        &self,
    ) -> &[(
    ...
    #[cfg(test)]
    fn floating_action_rects(&self) -> &[katana_ui_core::render_model::UiRect] {
...
mod tests {
    ...
    fn readonly_does_not_assign_semantics_to_an_enabled_opaque_command() {
        ...
        let projection = super::super::SanitizedCommandProjection::new([
            super::super::SanitizedCommandGroup::new(1, "generic").item(
                super::super::SanitizedCommandItem::new(
                    super::super::SanitizedCommandTarget::from_opaque_bytes([7])
    ...
    fn physical_text_selection_controls_floating_surface_lifecycle() {
        ...
        .item(SanitizedCommandItem::new(
            SanitizedCommandTarget::from_opaque_bytes(b"top-target-secret").with_unit_capability({
