...
use crate::text_command_surface::sanitized_document_root::sanitized_command_event::route_command_events;
use crate::text_command_surface::sanitized_document_root::sanitized_context_event::route_context_menu_events;
use crate::text_command_surface::sanitized_document_root::sanitized_document_root_input::SanitizedDocumentRootInput;
use crate::text_command_surface::sanitized_document_root::sanitized_document_root_process::SanitizedDocumentRootProcess;
...
fn map_search_detach_error(
    _error: crate::text_command_surface::root::EguiTextCommandSurfaceRootEventSearchDetachError,
) -> SanitizedDocumentRootFactoryError {
    SanitizedDocumentRootFactoryError::EventBatchUnavailable
}

fn map_command_detach_error(
    _error: crate::text_command_surface::root::EguiTextCommandSurfaceRootEventCommandDetachError,
) -> SanitizedDocumentRootFactoryError {
    SanitizedDocumentRootFactoryError::EventBatchUnavailable
}
...
mod detach_error_tests {
    ...
    use crate::text_command_surface::sanitized_document_root::SanitizedDocumentRootFactoryError;
