...
const COMMAND_ROOT_VIEWPORT_SIZE: egui::Vec2 = egui::vec2(640.0, 480.0);

pub(super) fn input_with_one_tab(revision: u64) -> SanitizedDocumentRootInput {
...
pub(super) fn command_input_with_callbacks(
    revision: u64,
...
pub(super) fn floating_command_input(
    revision: u64,
    calls: Rc<RefCell<usize>>,
    enabled: bool,
    visible: bool,
...
pub(super) fn context_menu_node(
    output: &egui::FullOutput,
    label: &str,
) -> (egui::accesskit::NodeId, egui::Rect) {
...
pub(super) fn run_command_root_frame(
...
pub(super) fn run_command_root_frame_result(
    context: &egui::Context,
    root: &mut super::SanitizedDocumentRoot,
    events: Vec<egui::Event>,
) -> (
...
pub(super) fn assert_command_forwarded_once(
