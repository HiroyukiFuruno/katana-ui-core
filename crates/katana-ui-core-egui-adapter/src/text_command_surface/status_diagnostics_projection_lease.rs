...
impl StatusDiagnosticsProjectionLease {
    ...
    #[must_use]
    pub fn with_status_bar(mut self, status_bar: katana_ui_core::molecule::StatusBar) -> Self {
    ...
    pub(super) fn into_parts(
        ...
        Option<katana_ui_core::molecule::StatusBar>,
        Option<katana_ui_core::molecule::DiagnosticsList>,
    ) {
