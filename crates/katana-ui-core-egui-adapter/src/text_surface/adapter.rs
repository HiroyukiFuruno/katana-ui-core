...
impl EguiTextSurfaceAdapter {
    ...
    pub(crate) fn show_with_input_policy_unpainted(
        ...
        if input_policy.publish_text_input_target {
            crate::text_command_surface::accesskit_evidence::record(
                ui.ctx(),
                crate::text_command_surface::accesskit_evidence::AccessKitEvidence {
                    ...
                    target_class: crate::text_command_surface::accesskit_evidence::AccessKitTargetClass::TextInput,
                },
            );
        }
        if input_policy.publish_context_target {
            crate::text_command_surface::accesskit_evidence::record(
                ...
                crate::text_command_surface::accesskit_evidence::AccessKitEvidence {
                    ...
                    target_class: crate::text_command_surface::accesskit_evidence::AccessKitTargetClass::TextSurfaceContextTarget,
                },
            );
        }
