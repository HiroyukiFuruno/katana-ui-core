...
use katana_ui_core::molecule::command_chrome::{
    ...
    CommandChromeDropdownTrigger, CommandChromeFamilyId, CommandChromeSearchPresentation,
    CommandChromeSearchStrip, CommandChromeText, CommandChromeToolbar,
    CommandChromeToolbarPresentation, SearchControlCapabilities, SearchControlIcons,
...
use katana_ui_core::render_model::{UiStateId, UiTextSpan};
...
pub fn toolbar_fixture() -> CommandChromeToolbar {
    ...
    CommandChromeToolbar::new()
        .command_family(CommandChromeFamilyId::new("fixture-primary"))
...
pub fn floating_toolbar_fixture() -> CommandChromeToolbar {
    ...
    CommandChromeToolbar::new()
        .command_family(CommandChromeFamilyId::new("fixture-floating"))
        .action(
...
pub fn toolbar_presentation() -> CommandChromeToolbarPresentation {
    CommandChromeToolbarPresentation {
        actions: vec![action("inline-bold", "同期太字", false)],
        groups: Vec::new(),
...
pub fn floating_toolbar_presentation() -> CommandChromeToolbarPresentation {
...
pub fn search_presentation() -> CommandChromeSearchPresentation {
...
pub fn search_presentation_state_id() -> UiStateId {
    UiStateId::new("storybook.command-chrome.search")
}
