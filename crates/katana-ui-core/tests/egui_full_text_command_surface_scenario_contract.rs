...
fn render(
    ...
    root: &mut katana_ui_core::egui::text_command_surface::EguiTextCommandSurfaceHostRoot,
    stage: Option<&katana_ui_core::egui::text_command_surface::FullTextCommandSurfaceRawInputStage>,
) -> String {
...
fn find_query_navigation_close_and_disabled_replace_use_only_kuc_opaque_targets() {
    ...
    assert!(matches!(
        ...
        Err(katana_ui_core::egui::text_command_surface::KucInteractionLocatorError::Disabled)
    ));
    assert!(matches!(
        committed
            .interaction_locator()
    ...
    assert!(matches!(
        ...
        Err(katana_ui_core::egui::text_command_surface::KucInteractionLocatorError::Missing)
    ));
}
...
fn generic_language_dropdown_opens_all_choices_and_forwards_a_physical_selection() {
    ...
    assert!(matches!(
        ...
        Err(katana_ui_core::egui::text_command_surface::KucInteractionLocatorError::Hidden)
    ));
...
fn issue_remains_backward_compatible_and_lease_is_one_shot() {
    ...
    assert!(matches!(
        error,
        katana_ui_core::egui::text_command_surface::
