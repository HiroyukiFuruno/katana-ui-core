...
fn root_frame_public_surface_is_closed_to_child_outputs() {
    let source = include_str!("../src/egui/text_command_surface/root_frame.rs");
    let body = source
...
fn public_root_event_forwarding_contract_is_opaque_and_child_free() {
    let transport_source = include_str!("../src/egui/text_command_surface/root_event.rs");
    ...
    let transport_impl = include_str!("../src/egui/text_command_surface/root_event/transport.rs");
    assert!(
        transport_impl
            .contains("formatter.write_str(\"EguiTextCommandSurfaceRootEventTransport(..)\")")
    );

    let batch_source = include_str!("../src/egui/text_command_surface/root_event_types.rs");
    ...
    let split_contract = concat!(
        include_str!("../src/egui/text_command_surface/root_event.rs"),
        include_str!("../src/egui/text_command_surface/root_event_contract.rs"),
        include_str!("../src/egui/text_command_surface/root_event_core.rs"),
        include_str!("../src/egui/text_command_surface/root_event_detach.rs"),
        include_str!("../src/egui/text_command_surface/root_event_transport.rs"),
        include_str!("../src/egui/text_command_surface/root_event_types.rs"),
    );
...
fn opaque_host_effect_batch_contract_has_no_semantic_readback_or_value_traits() {
    let source = include_str!("../src/egui/text_command_surface/root_event_contract.rs");
