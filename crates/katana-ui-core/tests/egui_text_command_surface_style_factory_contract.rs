#![cfg(feature = "egui")]
use katana_ui_core::egui::text_command_surface::TextCommandSurfaceStyle;
...
fn sanitized_root_delegates_to_the_generic_factory() {
    let builder =
        include_str!("../src/egui/text_command_surface/sanitized_document_root_style_builder.rs");
    assert!(builder.contains("TextCommandSurfaceStyle::standard()"));

    let factory =
        include_str!("../src/egui/text_command_surface/text_command_surface_style_factory.rs");
