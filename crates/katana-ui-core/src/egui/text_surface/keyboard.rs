...
fn vertical_target_grapheme(
    layout: &TextSurfaceLayout,
    caret: usize,
    current_rect: crate::render_model::UiRect,
    down: bool,
) -> usize {
...
mod tests {
    use super::*;
    use crate::atom::{TextArea, TextAreaEvent};
    use crate::render_model::{UiRect, UiTextSpan};
    use crate::text_surface::{TextSurfaceGraphemeBox, TextSurfaceProps, TextSurfaceViewport};
