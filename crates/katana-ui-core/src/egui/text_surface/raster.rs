...
use crate::render_model::{UiRect, UiTextSpan, UiTextSpanStyle};
...
) -> crate::text_surface::TextSurfaceLayout {
...
fn record_metrics(
    ...
    rasterizer: &mut PlatformTextRasterizer,
    text: &str,
    font: &crate::theme::FontToken,
    scale_factor: f32,
) -> Result<crate::text_raster::PlatformTextMetrics, EguiTextSurfaceError> {
    metrics
        .borrow_mut()
        .measure_text(
            rasterizer,
