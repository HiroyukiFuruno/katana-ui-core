...
pub(super) fn show_with_input_policy_unpainted(
    ...
    if input_policy.publish_context_target {
        crate::egui::text_command_surface::accesskit_evidence::AccessKitEvidenceLedger::record(
            ui.ctx(),
            crate::egui::text_command_surface::accesskit_evidence::AccessKitEvidence {
                ...
                target_class:
                    crate::egui::text_command_surface::accesskit_evidence::AccessKitTargetClass::TextSurfaceContextTarget,
            },
        );
    }
