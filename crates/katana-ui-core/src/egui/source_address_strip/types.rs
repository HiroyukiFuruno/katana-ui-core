use crate::egui::text_surface::{
    EguiTextSurfaceError, TextSurfacePaintStyle, TextSurfaceRasterStyle,
};
...
pub enum EguiSourceAddressStripError {
    ...
    Raster(crate::text_raster::PlatformTextRasterError),
    FrameNotProduced,
...
impl From<crate::text_raster::PlatformTextRasterError> for EguiSourceAddressStripError {
    fn from(value: crate::text_raster::PlatformTextRasterError) -> Self {
        Self::Raster(value)
    }
}
...
pub enum SourceAddressPaintOperationKind {
    Input(crate::egui::text_surface::TextSurfacePaintOperationKind),
    Fill {
        bounds: UiRect,
