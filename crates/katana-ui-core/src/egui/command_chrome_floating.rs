...
impl EguiCommandChromeAdapter {
    pub fn show_floating_toolbar(
        ...
        let measured_panel = crate::interaction::placement::Size::new(
        ...
        let toolbar_output = self.show_toolbar_unpainted(
            ...
            raster_style,
            paint_style,
            crate::egui::text_command_surface::accesskit_evidence::AccessKitTargetClass::FloatingToolbar,
        )?;
...
fn floating_toolbar_events(
    toolbar_events: Vec<crate::molecule::command_chrome::CommandChromeToolbarEvent>,
) -> Vec<FloatingCommandToolbarEvent> {
...
fn core_rect(bounds: crate::interaction::placement::Rect) -> UiRect {
