use crate::egui::text_command_surface::root::EguiTextCommandSurfaceRootOutput;
use crate::egui::text_command_surface::sanitized_document_root::sanitized_command_event::SanitizedCommandActivationTransport;
use crate::egui::text_command_surface::sanitized_document_root::sanitized_context_event::SanitizedContextMenuActivationTransport;
...
use crate::egui::text_command_surface::sanitized_document_root::sanitized_search_event::SanitizedSearchEventTransport;
use crate::egui::text_command_surface::sanitized_document_root::sanitized_tab_projection::adapter::SanitizedTabProjectionClosedEvent;
...
pub struct SanitizedDocumentRootFrame {
    ...
    pub(super) command_action_rects: Vec<(
        crate::render_model::UiRect,
        Option<crate::render_model::UiRect>,
    )>,
    #[cfg(test)]
    pub(super) floating_action_rects: Vec<crate::render_model::UiRect>,
}
...
impl SanitizedDocumentRootFrame {
    ...
    #[cfg(test)]
    pub(super) fn floating_action_rects(&self) -> &[crate::render_model::UiRect] {
