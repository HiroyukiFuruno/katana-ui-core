...
fn input() -> KucUnicodeColorGlyphEvidenceInput {
    KucUnicodeColorGlyphEvidenceInput {
        profile: crate::text_raster::PlatformFontProfile::Linux,
        catalog_policy: crate::text_raster::PlatformFontCatalogPolicy::new(
            crate::text_raster::PlatformFontProfile::Linux,
            Vec::new(),
            Vec::new(),
            Vec::new(),
        ),
        face: crate::text_raster::PlatformColorEmojiFaceRecord {
            platform_profile: crate::text_raster::PlatformFontProfile::Linux,
            ...
            availability: crate::text_raster::PlatformColorEmojiAvailability::Resolved,
        },
