use crate::egui::command_chrome::EguiCommandChromeError;
use crate::egui::context_menu::ContextMenuAdapterError;
use crate::egui::text_surface::EguiTextSurfaceError;
...
pub enum EguiTextCommandSurfaceError {
    ...
    SourceAddress(crate::egui::source_address_strip::EguiSourceAddressStripError),
    Diagnostics(crate::egui::diagnostics_list::EguiDiagnosticsListError),
    StatusBar(crate::egui::status_bar::EguiStatusBarError),
...
impl From<crate::egui::source_address_strip::EguiSourceAddressStripError>
    for EguiTextCommandSurfaceError
{
    fn from(value: crate::egui::source_address_strip::EguiSourceAddressStripError) -> Self {
        Self::SourceAddress(value)
    }
}

impl From<crate::egui::diagnostics_list::EguiDiagnosticsListError> for EguiTextCommandSurfaceError {
    fn from(value: crate::egui::diagnostics_list::EguiDiagnosticsListError) -> Self {
        Self::Diagnostics(value)
    }
}

impl From<crate::egui::status_bar::EguiStatusBarError> for EguiTextCommandSurfaceError {
    fn from(value: crate::egui::status_bar::EguiStatusBarError) -> Self {
