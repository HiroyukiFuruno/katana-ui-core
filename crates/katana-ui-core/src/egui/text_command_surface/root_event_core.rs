...
mod tests {
    ...
    use crate::egui::text_command_surface::root::root_event::EguiTextCommandSurfaceRootEventBatch;
    use crate::egui::text_command_surface::root::root_event::root_event_payload::RootEventPayload;
    use crate::egui::text_command_surface::{KucOpaqueHostEffectBatch, KucOpaqueHostEffectError};
    ...
    impl crate::egui::text_command_surface::KucRootEventBatchForwarder for TestForwarder {
        type Error = ();

        fn forward_root_event_batch(
            &mut self,
            transport: crate::egui::text_command_surface::EguiTextCommandSurfaceRootEventTransport,
        ) -> Result<(), Self::Error> {
            assert_eq!(
                format!("{transport:?}"),
                "EguiTextCommandSurfaceRootEventTransport(..)"
