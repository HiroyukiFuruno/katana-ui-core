...
use crate::egui::diagnostics_list::EguiDiagnosticsListError;
use crate::egui::source_address_strip::EguiSourceAddressStripError;
use crate::egui::status_bar::EguiStatusBarError;
use crate::egui::text_command_surface::TabStripProposalPortError;
use crate::egui::text_command_surface::tab_strip_retained::TabStripRetainedError;
use crate::egui::text_surface::EguiTextSurfaceError;
use crate::molecule::command_chrome::CommandChromeFamilyId;
use crate::text_raster::PlatformTextRasterConfig;
...
fn error_variants_cover_display_conversion_and_debug() {
    ...
    let diagnostics = EguiTextCommandSurfaceError::Diagnostics(EguiDiagnosticsListError::Raster(
        crate::text_raster::PlatformTextRasterError::EmptyText,
    ));
    assert!(
        diagnostics
            .to_string()
