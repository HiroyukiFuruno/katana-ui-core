...
fn synchronize_context_menu(
    target: &mut Option<crate::egui::context_menu::ContextMenuPresentation>,
    value: Option<crate::egui::context_menu::ContextMenuPresentation>,
) -> bool {
    if *target == value {
        return false;
    }
...
fn synchronize_toolbar(
    ...
    value: Option<crate::molecule::command_chrome::CommandChromeToolbarPresentation>,
) -> bool {
    match value {
        Some(value) => {
