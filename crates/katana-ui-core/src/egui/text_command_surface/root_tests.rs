...
mod tests {
    ...
    use crate::egui::artifact_compositor::ArtifactCompositeError;
    use crate::egui::context_menu::{ContextMenuPresentation, ContextMenuPresentationItem};
    use crate::egui::text_command_surface::EguiTextCommandSurfaceArtifactError;
    ...
    fn status_diagnostics_lease_mounts_both_children_in_an_actual_root_frame() {
        ...
        root.attach_status_diagnostics(
            StatusDiagnosticsProjectionLease::new()
                .with_status_bar(crate::molecule::StatusBar::new("status").segment(
                    crate::molecule::StatusBarSegment::new("status-segment", "Ready"),
                ))
                .with_diagnostics_list(crate::molecule::DiagnosticsList::new("diagnostics")),
        );
        ...
        assert!(
            output.artifact_order().contains(
                &crate::egui::text_command_surface::EguiTextCommandSurfaceChild::StatusBar
            )
        );
        assert!(output.artifact_order().contains(
            &crate::egui::text_command_surface::EguiTextCommandSurfaceChild::DiagnosticsList,
        ));
    }
    ...
    fn selected_surface() -> crate::text_surface::TextSurface {
        ...
        let mut presentation = crate::text_surface::TextSurfacePresentation::from_props(&props);
