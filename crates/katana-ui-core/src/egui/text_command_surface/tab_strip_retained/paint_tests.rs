...
use super::*;
use crate::egui::text_command_surface::tab_strip_proposal_port::{
...
fn render_icon_control_records_disabled_and_enabled_background_branches() {
    ...
    let mut platform_output = context.run_ui(egui::RawInput::default(), |ui| {
        let enabled_presentation =
            crate::egui::text_command_surface::TabStripControlPresentation::new(
                TabStripText::new("next"),
                TabStripText::new("next"),
            );
        let disabled_presentation =
            crate::egui::text_command_surface::TabStripControlPresentation::new(
                TabStripText::new("next"),
                TabStripText::new("next"),
            );
...
impl TabStripProposalPort for NullPort {
    fn forward_proposal(
        &mut self,
        _proposal: crate::egui::text_command_surface::tab_strip_proposal_port::TabStripProposal,
