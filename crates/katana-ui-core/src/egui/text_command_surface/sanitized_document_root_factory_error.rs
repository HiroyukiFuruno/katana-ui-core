use crate::egui::text_command_surface::sanitized_document_root::sanitized_document_root_process::SanitizedDocumentRootProcessError;
...
pub enum SanitizedDocumentRootFactoryError {
    ...
    SearchCapability(crate::egui::text_command_surface::sanitized_document_root::sanitized_search_projection::SanitizedSearchCapabilityRejection),
    CommandCapability(crate::egui::text_command_surface::sanitized_document_root::sanitized_command_projection::SanitizedCommandCapabilityRejection),
    ContextMenuCapability(
        crate::egui::text_command_surface::sanitized_document_root::sanitized_context_projection::SanitizedContextMenuCapabilityRejection,
    ),
}
