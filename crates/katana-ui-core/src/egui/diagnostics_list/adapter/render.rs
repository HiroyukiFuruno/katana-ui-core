...
use crate::molecule::{DiagnosticSeverity, DiagnosticsList, DiagnosticsListAction};
    ...
    fn render_scopes_and_severity(
        ...
        if !snapshot.scopes.is_empty() {
            ...
            for scope in &snapshot.scopes {
                ...
                DiagnosticsAccessibility::publish_accessibility_with_enabled(
                    ...
                    identity,
                    crate::egui::text_command_surface::accesskit_evidence::AccessKitTargetClass::DiagnosticsScope,
                    scope_count > 1,
                );
                if scope_count > 1
        ...
        for severity in DiagnosticSeverity::all() {
            ...
            DiagnosticsAccessibility::publish_accessibility(
                ...
                crate::egui::text_command_surface::accesskit_evidence::AccessKitTargetClass::DiagnosticsSeverityFilter,
            );
