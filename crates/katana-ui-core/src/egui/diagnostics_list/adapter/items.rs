...
use crate::molecule::{DiagnosticsList, DiagnosticsListAction};
...
struct DisclosureRenderContext<'a> {
    ...
    item: &'a crate::molecule::DiagnosticItem,
    expanded: bool,
    bounds: egui::Rect,
...
impl EguiDiagnosticsListAdapter {
    pub(super) fn render_items(
        ...
        for (index, item) in visible_items {
            ...
            DiagnosticsAccessibility::publish_accessibility(
                ...
                crate::egui::text_command_surface::accesskit_evidence::AccessKitTargetClass::DiagnosticsItem,
            );
    ...
    fn render_quickfix(
        ...
        quickfix: &crate::molecule::DiagnosticAction,
        ...
        DiagnosticsAccessibility::publish_accessibility(
            ...
            crate::egui::text_command_surface::accesskit_evidence::AccessKitTargetClass::DiagnosticsFix,
        );
