use crate::egui::command_chrome::CommandChromePaintPlan;
use crate::egui::context_menu::ContextMenuPaintPlan;
use crate::egui::diagnostics_list::DiagnosticsListPaintPlan;
use crate::egui::source_address_strip::SourceAddressPaintPlan;
use crate::egui::status_bar::StatusBarPaintPlan;
use crate::egui::tab_strip_paint::TabStripPaintPlan;
use crate::egui::text_surface::TextSurfacePaintPlan;
