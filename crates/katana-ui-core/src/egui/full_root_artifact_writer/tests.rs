...
use crate::egui::FullRootArtifactWriter;
...
use crate::text_surface::{TextSurfaceProps, TextSurfaceViewport};
...
fn root_frame(stage_id: &str) -> EguiTextCommandSurfaceHostRootFrame {
    let presentation = EguiTextCommandSurfacePresentation {
        text_state_id: Some(crate::render_model::UiStateId::new(stage_id)),
...
fn text_surface_presentation() -> crate::text_surface::TextSurfacePresentation {
