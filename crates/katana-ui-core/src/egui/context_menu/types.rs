use crate::molecule::selection::{ContextMenuEvent, ContextMenuItemKind};
use crate::render_model::{RGBA_CHANNEL_COUNT, UiIconProps, UiRect};
...
pub struct EguiContextMenuAdapter {
    pub(super) menu: crate::molecule::selection::ContextMenu,
    pub(super) presentation: ContextMenuPresentation,
    pub(super) anchor: Option<crate::egui::text_surface::TextSurfaceContextTargetAnchor>,
    ...
    pub(super) type_ahead: crate::molecule::selection::ContextMenuTypeAheadBuffer,
    pub(super) text_rasterizer: crate::text_raster::PlatformTextRasterizer,
    pub(super) metrics: crate::egui::text_surface::SharedTextMetrics,
    pub(super) svg_rasterizer: crate::svg_raster::UiSvgRasterizer,
    pub(super) textures: crate::egui::texture_cache::RgbaTextureCache,
}
