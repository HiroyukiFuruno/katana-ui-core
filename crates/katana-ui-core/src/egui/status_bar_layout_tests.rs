...
fn long_center_and_trailing_segments_are_elided_and_cannot_hit_outside_the_root() {
    ...
    crate::egui::run_ui_discard(&context, narrow_input(Vec::new()), |ui| {
    ...
    let mut output = None;
    crate::egui::run_ui_discard(&context, narrow_input(pointer_click), |ui| {
        egui::CentralPanel::default().show(ui, |ui| {
    ...
    crate::egui::run_ui_discard(&context, narrow_input(inside_click), |ui| {
        egui::CentralPanel::default().show(ui, |ui| {
