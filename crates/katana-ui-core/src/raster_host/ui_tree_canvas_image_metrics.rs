...
mod tests {
    ...
    #[test]
    fn requested_height_constrains_image_target_size_without_exceeding_width() {
        assert_eq!((13, 25), image_target_size(100.0, 200.0, 50, 25));
        assert_eq!((50, 100), image_target_size(100.0, 200.0, 50, 0));
    }
}
