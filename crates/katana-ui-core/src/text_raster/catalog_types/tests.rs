...
struct FakeLoader {
    result: Result<
        ...
        crate::text_raster::catalog_types::PlatformEmojiFontLoadError,
    >,
}

impl crate::text_raster::catalog_types::PlatformEmojiFontLoader for FakeLoader {
    fn load(
        &mut self,
        _candidate: &crate::text_raster::catalog_types::PlatformEmojiFontCandidate,
    ) -> Result<
        crate::text_raster::catalog_types::PlatformEmojiFontObservation,
        crate::text_raster::catalog_types::PlatformEmojiFontLoadError,
    > {
...
fn candidate(
    profile: PlatformFontProfile,
) -> crate::text_raster::catalog_types::PlatformEmojiFontCandidate {
    PlatformFontCatalogPolicy::for_profile(profile).emoji_candidates[0].clone()
}

fn observation(
    candidate: &crate::text_raster::catalog_types::PlatformEmojiFontCandidate,
    family: &str,
) -> crate::text_raster::catalog_types::PlatformEmojiFontObservation {
    crate::text_raster::catalog_types::PlatformEmojiFontObservation {
