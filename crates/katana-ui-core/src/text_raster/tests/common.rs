use crate::text_raster::{PlatformTextGraphemeBounds, PlatformTextRaster};
use crate::theme::{FontFamily, FontToken};

pub(super) const RGBA_CHANNEL_COUNT: usize = crate::text_raster::model::RGBA_CHANNEL_COUNT;
const RGBA_ALPHA_INDEX: usize = crate::text_raster::model::RGBA_ALPHA_INDEX;
