...
-> Result<(), Box<dyn std::error::Error>> {
    ...
    let mut presentation = super::TextSurfacePresentation::from_props(surface.props());
...
fn automatic_range_marker_ignores_invalid_utf8_offsets_and_reresolves_after_controlled_update() {
    ...
    let updated = "prefix\n日本語\n⭐️\nthird";
    let mut updated_presentation = super::TextSurfacePresentation::from_props(surface.props());
