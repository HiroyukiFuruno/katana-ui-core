...
pub(crate) fn max_scroll_y_for(
    ...
    overflow_for(region, selected_page, tree_expansion).max_y()
}
...
pub(crate) fn max_scroll_x_for(
    ...
    overflow_for(region, selected_page, tree_expansion).max_x()
}
...
fn preview_overflow(_selected_page: &str) -> PanelOverflow {
