use crate::visual::text::{RichTextStyle, TextRenderer};
...
#[derive(Clone, Copy)]
pub(in crate::visual) struct SpanTextRenderers<'a> {
    text: &'a TextRenderer,
    code: &'a TextRenderer,
}

impl<'a> SpanTextRenderers<'a> {
    pub(in crate::visual) const fn new(text: &'a TextRenderer, code: &'a TextRenderer) -> Self {
        Self { text, code }
    }

    pub(in crate::visual) fn for_span(self, span: &UiTextSpan) -> &'a TextRenderer {
...
pub(in crate::visual) fn span_line_width(
...
pub(in crate::visual) fn span_part_width(
    renderers: SpanTextRenderers<'_>,
    span: &UiTextSpan,
    metrics: UiTreeTextMetrics,
    preserve_whitespace: bool,
...
pub(in crate::visual) fn span_visible_part_bounds(
    renderers: SpanTextRenderers<'_>,
    span: &UiTextSpan,
    metrics: UiTreeTextMetrics,
    preserve_whitespace: bool,
...
pub(in crate::visual) fn span_rich_text_style(
    span: &UiTextSpan,
    metrics: UiTreeTextMetrics,
    color: u32,
) -> RichTextStyle {
...
pub(in crate::visual) fn whitespace_width(
    metrics: UiTreeTextMetrics,
    preserve_whitespace: bool,
) -> usize {
...
pub(in crate::visual) fn preserves_whitespace(node: &UiNode) -> bool {
