...
fn compact_heading_2_dark_preview_keeps_readable_ink_origin() -> Result<(), String> {
    ...
    let node: UiNode = Text::new("5.5 Short + Long + Short Columns")
        ...
        .into();
    let typography =
        crate::visual::ui_tree_canvas_text_metrics::UiTreeDocumentTypography::from_theme(&theme);
    ...
    UiTreeTextLines::draw_plain(
        ...
        UiTreeTextLineContext {
            ...
            node: &node,
            area,
            palette: crate::visual::ui_tree_canvas_palette::UiTreeCanvasPalette::from_theme(&theme),
            metrics,
        },
        area.x,
        area.x,
