...
fn button_cell(desc: &'static str, svg_str: String, size_px: f32, r: u8, g: u8, b: u8) -> impl IntoView {
    v_stack((
        ...
        label(move || desc).style(|s| s.font_size(9.0)),
    ))
...
fn page_content(theme: &Theme) -> impl IntoView + use<> {
    ...
    let mut rows: Vec<[(&str, String, f32, u8, u8, u8); 3]> = Vec::new();
    for (vname, variant) in variants {
        let mut row = [
            (vname, String::new(), 0.0f32, 0u8, 0u8, 0u8),
            (vname, String::new(), 0.0f32, 0u8, 0u8, 0u8),
            (vname, String::new(), 0.0f32, 0u8, 0u8, 0u8),
        ];
        for (i, (tname, tone)) in tones.iter().enumerate() {
            ...
            let icon_svg = katana_ui_widget::primitive::icon::Icon::new(r.icon_source)
                .size(IconSize::Lg)
                .resolve(theme);
            let desc = Box::leak(format!("{vname}/{tname}").into_boxed_str());
    ...
    scroll(
        v_stack((
            ...
            h_stack((
                button_cell(r0[0].0, r0[0].1.clone(), r0[0].2, r0[0].3, r0[0].4, r0[0].5),
                button_cell(r0[1].0, r0[1].1.clone(), r0[1].2, r0[1].3, r0[1].4, r0[1].5),
                button_cell(r0[2].0, r0[2].1.clone(), r0[2].2, r0[2].3, r0[2].4, r0[2].5),
            )).style(|s| s.gap(4.0)),
            h_stack((
                button_cell(r1[0].0, r1[0].1.clone(), r1[0].2, r1[0].3, r1[0].4, r1[0].5),
                button_cell(r1[1].0, r1[1].1.clone(), r1[1].2, r1[1].3, r1[1].4, r1[1].5),
                button_cell(r1[2].0, r1[2].1.clone(), r1[2].2, r1[2].3, r1[2].4, r1[2].5),
            )).style(|s| s.gap(4.0)),
            h_stack((
                button_cell(r2[0].0, r2[0].1.clone(), r2[0].2, r2[0].3, r2[0].4, r2[0].5),
                button_cell(r2[1].0, r2[1].1.clone(), r2[1].2, r2[1].3, r2[1].4, r2[1].5),
                button_cell(r2[2].0, r2[2].1.clone(), r2[2].2, r2[2].3, r2[2].4, r2[2].5),
            )).style(|s| s.gap(4.0)),
            label(|| "Disabled state").style(|s| s.font_size(16.0).margin_top(12.0).margin_bottom(8.0)),
            button_cell("Disabled", dis_svg, dis_size, dr, dg, db),
        ))
        .style(move |s| {
            s.gap(4.0)
                .padding(16.0)
...
pub fn svg_button_page() -> impl IntoView {
    let is_dark = create_rw_signal(false);

    v_stack((
        h_stack((
            label(|| "SvgButton").style(|s| s.font_size(20.0)),
