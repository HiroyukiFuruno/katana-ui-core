...
- [/] 4.1 `RUSTFLAGS="-D warnings" cargo test -p katana-ui-widget`
- [/] 4.2 `just storybook-check`
- [/] 4.3 `just ast-lint`
...
- [ ] 5.1 `proposal.md`、`design.md`、`specs/rgba-color-picker/spec.md` の受け入れ条件に沿って GUI 要素を実装する。
