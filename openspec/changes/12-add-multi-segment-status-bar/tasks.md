...
- [ ] 4.1 SingleMessage 主要 preset の回帰（既存）。
- [ ] 4.2 MultiSegment の leading / center / trailing 配置、segment 数 1〜5 を回帰する。
- [ ] 4.3 progress overlay、tooltip、popover 表示を回帰する。
- [ ] 4.4 density 2 種類、tone 各種を回帰する。
- [ ] 4.5 light / dark theme を回帰する。
