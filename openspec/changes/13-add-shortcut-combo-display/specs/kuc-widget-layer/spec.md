...
Atom contracts MUST explicitly define options, actions, events, state, presets, automated tests, numeric layout/rendering contracts, preview behavior, settings behavior, and Storybook pages.
